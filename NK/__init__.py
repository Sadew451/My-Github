...
print("[NK]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession()    
    
#install arq
print("[NK]: Initializing ARQ Client")
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)        
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient("NK", API_ID, API_HASH)
pbot = Client("NK", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from NK.modules.helper_funcs.handlers import (
