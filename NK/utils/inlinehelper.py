...
from NK import BOT_USERNAME, OWNER_ID, pbot, arq
from NK.utils.plh import convert_seconds_to_minutes as time_convert
from NK.utils.plh import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help ", url=f"t.me/{BOT_USERNAME}?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/c0b42594271a97c2b8818.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("𝐌𝐚𝐢𝐧 𝐁𝐨𝐭", url="https://t.me/TheNatsukiBot"),
        InlineKeyboardButton("𝗚𝗼 𝗜𝗻𝗹𝗶𝗻𝗲!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Natsuki ✨](https://t.me/TheNatsukiBot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
