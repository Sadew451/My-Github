...
from NK.modules import ALL_MODULES
from NK.modules.helper_funcs.chat_status import is_user_admin
from NK.modules.helper_funcs.misc import paginate_modules
...
buttons = [
   ...
   # [
    ...
    #],
    [
        InlineKeyboardButton(text="☘ About Me 🍀", callback_data="mrjoker_"),
        InlineKeyboardButton(
            text=" Basic Help 👮", callback_data="mrjoker_basichelp"
        ),
    ],
    
    [
        InlineKeyboardButton(text="➕️ Add Me To Group ➕️", url="http://t.me/AnimX_Robot?startgroup=true"),
    ],
]


HELP_STRINGS = """
👋𝐇𝐞𝐥𝐥𝐨! I Am ANim Manager [✨](https://telegra.ph/file/0003ddc9a28524f99877f.png)
...
Power By @senuinfinity """



DONATE_STRING = """ @SenuGamerBoy"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
           "👋Hi , \n\nI AM Only World Best System On Telegram \n\nI'm awake already!\n<b>Haven't slept since:</b> <code>{}</code>\nThanx For Using Me :)".format(
               uptime
            ),
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ 📣", url="t.me/senuinfinitygroup")]]
            ),
        )
...
def mrjoker_about_callback(update, context):
    ...
    if query.data == "mrjoker_":
        query.message.edit_text(
            ...
            text=f"*👋 Hi again! ,  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Senu Infinity 🇱🇰 TEAM .* "
            f"\n\n 🔥 Join [Senu Infinity](https://t.me/senuinfinity) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/0003ddc9a28524f99877f.png)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Sᴜᴘᴘᴏʀᴛ 📣", url="https://t.me/senuinfinitygroup"
                        ),
                        InlineKeyboardButton(
                            text="Uᴘᴅᴀᴛᴇꜱ 🛡", url="https://t.me/senuinfinity"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Admin 👮‍♂️", callback_data="mrjoker_admin"),
